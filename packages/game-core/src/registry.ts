...
export const MINIGAMES: readonly MinigameEntry[] = [
  {
    ...
    implemented: true,
    levels: {
      1: { safeZones: 3, hostileZones: 1, safeWidth: 0.09, hostileWidth: 0.05, speed: 0.18, missPenalty: 0.25 },
      2: { safeZones: 3, hostileZones: 2, safeWidth: 0.07, hostileWidth: 0.055, speed: 0.25, missPenalty: 0.35 },
      3: { safeZones: 4, hostileZones: 2, safeWidth: 0.045, hostileWidth: 0.06, speed: 0.35, missPenalty: 0.5 },
      4: { safeZones: 5, hostileZones: 3, safeWidth: 0.032, hostileWidth: 0.075, speed: 0.5, missPenalty: 0.65 },
      5: { safeZones: 6, hostileZones: 4, safeWidth: 0.022, hostileWidth: 0.09, speed: 0.72, missPenalty: 0.85 },
    },
    objective: 'Bloqueie todas as zonas seguras antes que a barra termine de varrer a trilha.',
    howTo: [
      'Observe a barra clara varrer a trilha da esquerda para a direita.',
      'Clique ou aperte Espaço quando ela estiver dentro de uma zona verde.',
      'Acerte todas as zonas verdes, na ordem em que aparecem.',
      'Não deixe a barra ultrapassar uma zona verde sem acionar.',
    ],
    failsWhen: [
      'A barra está dentro de uma zona vermelha no momento do acionamento.',
      'Você aciona fora de qualquer zona.',
      'Uma zona verde é ultrapassada sem bloqueio.',
      'A saúde da conexão chega a zero.',
    ],
    legend: [
      { symbol: '▮ verde', meaning: 'zona segura — acione aqui' },
      { symbol: '▮ vermelho', meaning: 'zona hostil — nunca acione aqui' },
      { symbol: '│ laranja', meaning: 'barra de varredura' },
    ],
...
export const createMinigame = (
  ...
  return entry.create({ seed, level, difficulty: resolveDifficulty(id, level, override) });
};
